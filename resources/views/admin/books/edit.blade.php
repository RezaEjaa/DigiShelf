...
@section('title', 'Edit Buku - Digishelf')
@section('page-title', 'Edit Buku')
@section('page-subtitle', 'Edit informasi buku')
...
<style>
    ...
    .btn-primary:hover { transform: translateY(-2px); box-shadow: 0 8px 20px rgba(93,64,55,0.3); }

    .btn-secondary { background: white; color: var(--wood-dark); border: 2px solid var(--wood-light); }
    ...
    <div class="form-card">
        <form action="{{ route('admin.books.update', $book->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                @error('title')<span style="font-size:0.82rem;color:#C62828;">{{ $message }}</span>@enderror
            </div>
            ...
            <div class="form-group">
                ...
                @error('author')<span style="font-size:0.82rem;color:#C62828;">{{ $message }}</span>@enderror
            </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    @error('isbn')<span style="font-size:0.82rem;color:#C62828;">{{ $message }}</span>@enderror
                </div>
                <div class="form-group">
                    ...
                    @error('publication_year')<span style="font-size:0.82rem;color:#C62828;">{{ $message }}</span>@enderror
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                @error('publisher')<span style="font-size:0.82rem;color:#C62828;">{{ $message }}</span>@enderror
            </div>
            ...
            <div class="form-group">
                ...
                @error('stock')<span style="font-size:0.82rem;color:#C62828;">{{ $message }}</span>@enderror
            </div>
            ...
            <div class="form-group">
                ...
                @error('description')<span style="font-size:0.82rem;color:#C62828;">{{ $message }}</span>@enderror
            </div>
            ...
            <div class="cover-upload-section">
                ...
                @error('cover_image')<span style="font-size:0.82rem;color:#C62828;">{{ $message }}</span>@enderror
            </div>
